            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="{{route('sistema.validateCreateUser')}}" method="post">
                            @csrf
                            ...
                            <h3 class="text-center text-info">Criar Usuário</h3>
                            ...
                            <div class="form-group">
                                <br>
                                <input type="submit" name="submit" class="btn btn-info btn-md" value="Criar conta">
                            </div>
                            <div id="register-link" class="text-right">
                                <a href="{{route('sistema')}}" class="text-info">Fazer login</a>
                            </div>
